...
<div class="fondo-login">
    <div class="icon">
        <a href="/login/index.php">
            <img  src="c://xampp/htdocs/login/asset/css/prueba.jpeg" ></img>
        </a>
    </div>
    <div class="titulo">
        Inicia sesion en Tefnu
    </div>
    ...
    <div class="login col-3 mt-3">
        Nuevo en Tefnu? <a href="signup.php" style="text-decoration: none;">Create una cuenta</a>
    </div>
</div>
